          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Formulir Pembelian</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">isi formulir dibawah ini</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row">
            <div class="col-6">
                <form action="send.php" method="post" target="_blank">
                    ...
                    <input type="hidden" name="noWa" value="62895703059940">
