                                        ...
                                        <!-- <div class="form-floating mb-3">
                                            ...
                                            <div class="row">
                                                <div class="form-floating mb-3 col">
                                                    ...
                                                    <label for="inputPassword" style="margin-left:12px">Kata Sandi</label>
                                                    <input class="form-check-input" type="checkbox" id="chk"> Lihat Kata Sandi
                                                </div>
                                                <script>
            ...
            <footer class="py-4 bg-light mt-5">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright &copy; Gadget - in Raihan</div>
                    </div>
                </div>
            </footer>
        </div>
...
function registrasi($data)
{
    ...
    // } else {
        ...
        //     move_uploaded_file($_FILES['gambar']['tmp_name'], 'user/gambar/' . $rand . '_' . $filename);
            mysqli_query($koneksi, "insert into data_user values('', '$username', '$password')");
