    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="active" href="features.php">Fitur</a></li>
          ...
          <div class="col-12">
            <div class="row justify-content-center">
              <div class="col-md-7 text-center hero-text">
                <h1 data-aos="fade-up" data-aos-delay="">Fitur Eternity Yours</h1>
                <p class="mb-5" data-aos="fade-up" data-aos-delay="100">Fitur Fitur Website Undangan Digital Kami</p>
              </div>
            </div>
          </div>
        </div>
